...
const Roadmap = () => {
  return (
    <div className="flex flex-col gap-6 bg-[#999999] items-center justify-start w-screen min-h-screen h-auto">
      <div
        id="about"
      ...
      >
        ...
        <div className="flex max-sm:flex-col gap-3">
          <div className="bg-white/20 glass-shadow mt-8 p-4 rounded-lg w-auto">
            <p className="max-sm:text-lg text-xl font-bold text-[#f7a97c]">
        ...
        <h1 className="text-[#ff9564] text-3xl mt-8">Tax and Others</h1>
      ...
      <h1 className="text-[#ff9564] text-lg md:text-xl lg:text-2xl">
