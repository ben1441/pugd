...
export default function Home() {
  return <div className="flex bg-[#9A6AEC] items-center justify-between h-screen w-screen">
    ...
    <div className="fixed -top-[40%] -left-[30%] md:-left-[50%] lg:-left-[55%] soft-circle w-[400px] lg:w-[581px] h-[400px] lg:h-[609px] flex-shrink-0"></div>
    <div className="fixed bottom-[10%] -right-[20%] soft-circle w-[200px] lg:w-[300px] h-[200px] lg:h-[300px] flex-shrink-0"></div>
