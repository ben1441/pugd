  ...
  return <div>
    <div className="flex bg-[#9A6AEC] items-center justify-between h-screen w-screen">
      ...
      <div className="flex flex-col items-start justify-center gap-6">
        <h1 className="wagmi-gradient mt-28 font-bold ml-6 min-[480px]:ml-10 sm:ml-32 lg:ml-40 min-[320px]:text-[80px] sm:text-[100px]">Wagmi</h1>
        <p className="text-white ml-6 min-[480px]:ml-10 sm:ml-32 lg:ml-40">Lorem ipsum dolor sit amet, consectetur adipiscing elitt</p>
        <div className="flex max-sm:flex-col max-sm:gap-8 items-start justify-end md:justify-between w-screen">
          <div className="flex max-sm:gap-6 ml-8 md:ml-32 gap-8">
            <Link href="#more">
